  ...
  return (
    <div className="w-full max-w-2xl xl:w-[850px] xl:max-w-none">
      <div className="grid grid-cols-2 gap-4 xl:grid-cols-4">
        ...
        {/* Location */}
        <div className="relative col-span-2 row-span-2 aspect-square rounded-xl">
        ...
        <div className="col-span-2 flex aspect-[2/1] flex-col justify-between rounded-xl bg-[#74F4F3] p-7 xl:aspect-auto">
        ...
        {/* Sunset */}
        <div className="row-span-2 rounded-xl bg-purple-500">
          <MBTIProfileBox />
        </div>
        <div className="aspect-square rounded-xl bg-gray-200">
